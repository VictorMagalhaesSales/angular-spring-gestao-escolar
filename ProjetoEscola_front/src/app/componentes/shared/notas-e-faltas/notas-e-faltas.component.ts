...
import { AlunoFiltro } from './../../aluno/aluno-filtro.model';
...
export class NotasEFaltasComponent implements OnInit {
  ...
  aparecerEditarNotas: boolean;
  aparecerEditarFaltas: boolean;
  ...
  mudarVisualizacaoNotas(){
    this.aparecerEditarNotas = !this.aparecerEditarNotas;
  }
  ...
  passarNotas(){
    ...
    this.passarNotasContinuacao(arrayNotas1);
    arrayNotas1.length = 0;
  }

  passarNotasContinuacao(notas: Array<NotasModel>){
  ...
  mudarVisualizacaoFaltas(){
    this.aparecerEditarFaltas = !this.aparecerEditarFaltas;
  }
  ...
  passarFaltas(){
    ...
    this.passarFaltasContinuacao(arrayFaltas1);
    arrayFaltas1.length = 0;
  }

  passarFaltasContinuacao(faltas: Array<FaltasModel>){
